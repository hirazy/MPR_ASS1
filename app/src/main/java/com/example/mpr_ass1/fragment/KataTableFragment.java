...
public class KataTableFragment extends Fragment implements CharacterAdapter.OnClick{
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        view = inflater.inflate(R.layout.fragment_table_kata, container, false);

        rclTable = view.findViewById(R.id.rlvTableKata);

        list = DataTable.listAlphabetTable();

        characterAdapter = new CharacterAdapter(list, false, getContext(), this);
